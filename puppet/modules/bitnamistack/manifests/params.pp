class bitnamistack::params {
    ...
    #Defaults to 64bits
    $install_file = "bitnami-lampstack-5.4.34-0-linux-x64-installer.run"
    $download_install_path = "https://bitnami.com/redirect/to/44575/$bitnamistack::params::install_file"
